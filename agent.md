...
Keep the thesis in formal academic Chinese and the README bilingual. Remove repeated explanations and unsupported claims. Distinguish prior-only rebalance inputs from retrospective specification selection.

Update text generators with the text they produce. Before publication, check that README, AGENTS, tables, figures, thesis and slides agree. Compile and inspect both PDFs. Commit or push only within the user's authorization.
