...
鲁棒性测试为验证性诊断，不新增模型、不重新调参，也不改变主结果表。运行 `python scripts/run_robustness_tests.py` 会生成 [汇总表](results/tables/robustness_overall_summary.csv)、[子区间检验](results/tables/robustness_subperiod_summary.csv)、[协方差检验](results/tables/robustness_covariance_summary.csv)、[交易成本检验](results/tables/robustness_transaction_cost_summary.csv)、[压力期检验](results/tables/robustness_stress_period_summary.csv)、[参数扰动检验](results/tables/robustness_parameter_perturbation.csv)、[无前视审计](results/tables/robustness_no_lookahead_audit.csv) 和 [求解器稳定性](results/tables/robustness_solver_stability.csv)。配套图包括 [子区间 Sharpe](results/figures/robustness_subperiod_sharpe.png)、[子区间回撤](results/figures/robustness_subperiod_drawdown.png)、[交易成本敏感性](results/figures/robustness_transaction_cost_sensitivity.png)、[协方差对比](results/figures/robustness_covariance_comparison.png)、[参数敏感性](results/figures/robustness_parameter_sensitivity.png) 和 [压力期表现](results/figures/robustness_stress_period_performance.png)。
