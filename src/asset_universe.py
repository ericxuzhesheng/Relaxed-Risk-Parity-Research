...
ETF_UNIVERSE: tuple[AssetMapping, ...] = (
    ...
    AssetMapping("科创芯片ETF",   "科创芯片ETF", "588200.SH", "china tech equity",
    ...
    AssetMapping("恒生科技ETF",   "恒生科技ETF", "513180.SH", "hong kong equity",
                 "Existing tradable Hang Seng Tech ETF."),
    # ── 全球股票 ──────────────────────────────────────────────────────────────
    AssetMapping("纳指ETF",       "纳指ETF",     "159941.SZ", "global equity",
                 "Existing tradable Nasdaq ETF."),
    AssetMapping("纳指科技ETF",   "纳指科技ETF", "159509.SZ", "global equity",
                 "Add concentrated US tech ETF for greater tech upside elasticity."),
