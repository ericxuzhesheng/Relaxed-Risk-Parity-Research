...
ETF_UNIVERSE: tuple[AssetMapping, ...] = (
    ...
    AssetMapping("芯片ETF",       "芯片ETF",     "159995.SZ", "china tech equity",
                 "Chip/IC-design ETF covering fabless semiconductor and wafer foundry companies in China."),
    AssetMapping("卫星ETF",       "卫星ETF",     "159206.SZ", "china tech equity",
                 "Commercial satellite ETF providing exposure to China low-earth orbit constellation buildout."),
