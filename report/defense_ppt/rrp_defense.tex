...
\begin{frame}{\etfCount{} 支全球 ETF：8 大风险来源（来自 src/asset\_universe.py）}
  ...
  \begin{center}
    \begin{tabular}{@{}>{\bfseries}l>{\raggedright\arraybackslash}p{4.8cm}@{\hspace{0.5cm}}>{\bfseries}l>{\raggedright\arraybackslash}p{3.8cm}@{}}
      \toprule
      类别 & 代表品种 & 类别 & 代表品种 \\
      \midrule
      债券（4）     & 国债、信用债、可转债、货币      & 行业与消费（3） & 证券、军工、消费 \\
      A股宽基（5）  & 沪深300/500/1000、创业板、红利  & 港股与贵金属（2）& 恒生ETF、白银LOF \\
      中国科技（7） & 半导体、AI、机器人、新能源、     & 全球股票（4）  & 纳指、标普500、日经、欧洲 \\
